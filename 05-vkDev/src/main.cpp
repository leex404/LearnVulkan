...
const std::string title = "Vulkan - Draw with depth buffer";
const std::string vertShaderPath = "../../resources/shaders/05/vert.spv";
const std::string fragShaderPath = "../../resources/shaders/05/frag.spv";
