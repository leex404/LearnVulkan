...
private:
	void initWindow()
	{
		...
		window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan - Draw triangles with uniform", nullptr, nullptr);
	...
	void createGraphicsPipeline()
	{
		...
		std::vector<char> vertShaderCode = readFile("../../resources/shaders/03/vert.spv");
		std::vector<char> fragShaderCode = readFile("../../resources/shaders/03/frag.spv");
