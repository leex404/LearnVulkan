...
const std::string title = "Vulkan - Draw with texture";
const std::string vertShaderPath = "../../resources/shaders/04/vert.spv";
const std::string fragShaderPath = "../../resources/shaders/04/frag.spv";
