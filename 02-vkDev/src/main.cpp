...
private:
	void initWindow()
	{
		...
		window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan - Draw a triangle with vertex buffer", nullptr, nullptr);
	...
	void createGraphicsPipeline()
	{
		...
		std::vector<char> vertShaderCode = readFile("../../resources/shaders/02/vert.spv");
		std::vector<char> fragShaderCode = readFile("../../resources/shaders/02/frag.spv");
	...
	void createFramebuffers()
	{
		...
		for (size_t idx = 0; idx < swapChainImageViews.size(); idx++)
		{
			VkImageView attachments[] = { swapChainImageViews[idx] };
